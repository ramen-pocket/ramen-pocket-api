...
import { PostStoreCommentHandler } from '../../controllers/store/post-store-comment-handler';
...
const postStoreCommentHandler = new PostStoreCommentHandler(commentService);
const guarantee = new Guarantee(postStoreCommentHandler);
